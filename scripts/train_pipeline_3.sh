#!/bin/bash
#SBATCH --job-name=train_pipeline_3
#SBATCH --output=logs/train_pipeline_3_%j.out
#SBATCH --error=logs/train_pipeline_3_%j.err
...
# ---- Paths / args ----
SCRIPT=scripts/train/train_pipeline_3.py
