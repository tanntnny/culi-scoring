#!/bin/bash
#SBATCH --job-name=train_baseline_2
#SBATCH --output=logs/train_baseline_2_%j.out
#SBATCH --error=logs/train_baseline_2_%j.err
...
# ---- Paths / args ----
SCRIPT=scripts/train/train_baseline_2.py

TRAIN_DATA=assets/train_common.csv
VAL_DATA=assets/val_common.csv
...
K_PROTOTYPES=3
PT_METRIC=sed
TEXT_PROCESSOR=models/text-tokenizer
TEXT_ENCODER=models/text-model
